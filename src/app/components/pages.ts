...
const projects: Record<string, PageMetadata> = {
    ...
    '/resitogether': {
        title: 'ResiTogether',
        description: 'App prototype to improve employment among formerly incarcerated persons',
        ...
        href: '/resitogether',
        date: '2023-06-05',
        authors: 'Drew King, Weather Nguyen, Taylor Richmond, Julie McUne, Jessica Wang'
    },
    '/sl-screens': {
        title: 'SL Screens',
