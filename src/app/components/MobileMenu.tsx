  ...
  return (
    <div className="md:hidden">
      ...
      <nav
        ...
        className="flex items-center justify-between w-[80vw] mx-auto h-auto"
      >
        <button
          className="md:hidden"
        ...
        >
          <button className="md:hidden flex items-center">
            <MdCollectionsBookmark aria-hidden="true" size={16} />
            <p className="md:hidden sr-only">Download CV</p>
          </button>
        </Link>
      </nav>
      {/* Mobile menu overlay */}
