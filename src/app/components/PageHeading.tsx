  ...
  return (
    <div itemScope itemType="https://schema.org/CreativeWork">
      <div
        ...
        className="image-head-container relative md:mt-4 md:pt-4 sm:mt-12 sm:pt-0"
      >
        <Image
          itemProp="thumbnail"
          fill={false}
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
          ...
          <p itemProp="author" className="hidden sm:block text-center text-sm">
            {metadata.authors}
          </p>
        </div>
      </div>
      ...
      <div className="sm:hidden flex flex-col items-center justify-center gap-1 py-6">
        <time className="text-center" dateTime={metadata.date}>
          {metadata.date}
        </time>
        <p itemProp="caption" className="text-center px-4">
          {metadata.description}
        </p>
        <p itemProp="authors" className="text-sm">
          {metadata.authors}
        </p>
      </div>
    </div>
