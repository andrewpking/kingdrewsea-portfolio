...
export const metadata = projects['/resitogether'];
...
<FigmaEmbed 
  src="https://embed.figma.com/proto/QIOjt1AWxGjAiwFjbiTTuI/ResiTogether-Interactive-Prototype?node-id=1-6956&p=f&scaling=scale-down&content-scaling=fixed&page-id=14%3A1851&starting-point-node-id=1%3A6956&show-proto-sidebar=1&embed-host=kingdrewsea.vercel.app&client-id=EQWgZkB6TymItq3WmtyAZ8&theme=system"
...
<ProjectImagesBlock
  images={[
    {
      src: "/images/resitogether/image2.png",
      alt: "Graph showing job board usage",
      caption: "Of those incarcerated, all of them use indeed and no other job board."
    },
    {
      src: "/images/resitogether/image4.png",
      alt: "Graph showing conviction rates",
      caption: "Only 3 people reported being convicted of a crime."
    },
    {
      src: "/images/resitogether/image9.png",
      alt: "Graph showing conviction types",
      caption: "One respondent had both a misdemeanor and felony."
    },
    {
      src: "/images/resitogether/image6.png",
      alt: "Graph showing age distribution",
      caption: "The distribution is skewed lower for the general population, but our sample size for incarcerated people was very small, and older than our general population."
    },
    {
      src: "/images/resitogether/image8.png",
      alt: "Graph showing employment gaps",
      caption: "The incarcerated population had less employment gaps on their resume than the general population and seemed less affected by them than the general population"
    },
    {
      src: "/images/resitogether/image1.png",
      alt: "Graph showing career coaching usage",
      caption: "Career Coaching was used more by formerly incarcerated individuals than the average population, but both reported it is only marginally effective."
    },
    {
      src: "/images/resitogether/image3.png",
      alt: "Graph showing resume coaching effectiveness",
      caption: "Resume coaching was reported to be used more by incarcerated persons and to be much more effective for them. In our user interviews many formerly incarcerated people also mentioned need for these services and lack of access due to inflexible hours."
    }
  ]}
  direction="column"
  width={5}
...
Avery, B., & Lu, H. (2022, November 29). [_Ban the box: U.S. cities, counties, and states adopt fair hiring policies_](https://www.nelp.org/publication/ban-the-box-fair-chance-hiring-state-and-local-guide/). National Employment Law Project. Retrieved April 27, 2023

[Ban the box](http://bantheboxcampaign.org/about/#.ZEHOcHbMKUm). (n.d.). Retrieved May 4, 2023

[_Learning & Working Programs_](https://www.doc.wa.gov/corrections/programs/learning-working.htm). Learning & Working Programs | Washington State Department of Corrections. Retrieved April 27, 2023

Leins, C. (2019, September 10). [_‘ban the box’ laws could negatively impact minorities - US news_](https://www.usnews.com/news/best-states/articles/2019-09-10/ban-the-box-laws-could-negatively-impact-minorities). More Data Needed to Determine Whether 'Ban the Box' Laws Work. Retrieved April 27, 2023

Maurer, R. (2021, October 19). [_Ban-the-box movement goes viral_](https://www.shrm.org/ResourcesAndTools/hr-topics/risk-management/Pages/Ban-the-Box-Movement-Viral.aspx). SHRM. Retrieved April 27, 2023

Wang, L., & Bertram, W. (2022, February 8). [_New Data on formerly Incarcerated People's employment reveal labor market injustices_](https://www.prisonpolicy.org/blog/2022/02/08/employment/). Prison Policy Initiative. Retrieved April 27, 2023

WP Company. (2021, December 1). [_Prisons are training inmates for the next generation of in-demand jobs_](https://www.washingtonpost.com/education/2021/11/26/prison-education-programs-career-tech/). The Washington Post. Retrieved April 27, 2023

Zoukis, C. (2022, May 10). [_Vocational training in prison_](https://federalcriminaldefenseattorney.com/prison-research-papers/vocational-training-in-prison/#:~:text=Vocational%20training%20programs%20in%20prisons,and%20stay%20out%20of%20prison.). Law Offices of Grant Smaldone. Retrieved April 27, 2023
