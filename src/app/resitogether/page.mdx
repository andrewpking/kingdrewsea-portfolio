...
<ProjectImagesBlock
  images={[
    { src: '/images/resitogether/wireframe2.png', alt: 'ResiTogether wireframe 2', caption: 'Multiple resume feeds are available, one for users followed and another of all resumes in chronological order. Users can search for resumes by hashtag. Each resume is displayed as a social media listings and follow social media UI conventions. Hashtags along bottom can be used to find other resumes via a folksonomy. Sharing copies with a link of the resume is possible. Users can upload or create a new resume at any time from the skeumorphic icon.' },
    { src: '/images/resitogether/wireframe3.png', alt: 'ResiTogether wireframe 3', caption: "Three panes allow for organizing the educational portion of this app by content tailored for job search, supporting people who may be struggling while looking for work, and allowing users to save stories for later retrieval. Learnings can be searched by hashtag. Information is organized in chronological order with hashtags available to find similar stories, following social media conventions. Sharing saves a link to the clipboard of the user." },
  ]}
  direction={"row"}
  width={2}
  maxHeight={400}
...
- https://www.doc.wa.gov/corrections/programs/learning-working.htm  this is like a hub area that goes indepth and has many links to a wide variety of programs.
...
- Some notable news articles that goes on to talk about these programs are from “The Washington Post” https://www.washingtonpost.com/education/2021/11/26/prison-education-programs-career-tech/
- ![](/images/resitogether/image7.png)

#### Felony Record Hub 

- Felony record hub is a website that has an extensive amount of support that specializes in helping incarcerated individuals who were just released from prison to get an opportunity at a second chance. The reason why people use this website is it provides a list of information on open jobs, companies looking for employees, information on where to get housing, locations, programs that help to smooth transitions back into the public, and community pages for members who want to connect with others.
- https://www.felonyrecordhub.com/
...
- ![](images/resitogether/image5.png)
...
#### Ban The Box 
- In the early 2000s civil and human rights organization “All of Us or None” launched the Ban The Box campaign that fought for the rights of formerly incarcerated people. Ban the Box aims to eliminate discrimination against job applicants who have prior criminal records and allows people to utilize this resource to promote ethical hiring procedures and lower barriers to finding employment for individuals with criminal records. This policy has been adopted by over 30+ states nationwide. 
- https://www.nelp.org/publication/ban-the-box-fair-chance-hiring-state-and-local-guide/
- http://bantheboxcampaign.org/about/#.ZEHOcHbMKUm
- One thing that Ban the box policy does well is by removing questions in job applications that specifically talk about past convictions that an applicant might have been apart off. 
...
- There are articles that talk about the positive and negative on this solution 
- ![](/images/resitogether/image11.png)
- https://www.usnews.com/news/best-states/articles/2019-09-10/ban-the-box-laws-could-negatively-impact-minorities
- ![](/images/resitogether/image10.png)

|                                                   | **Existing Solution 1** **Vocational training**                                                                                                                                                                                                                                                          | **Existing Solution 2** **Felony record hub**                                                                                                                                              | **Existing Solution 3 “Ban the Box**                                                                                                                                                                          |
| **What does the existing solution do well? **     | Trains incarcerated individuals to gain some valuable skills to get jobs when they are released. This program allows incarcerated persons to upskill while they are in prison.                                                                                                                           | Expansive amount of links that gives an abundance of information. Aggregates jobs available to felons into a single place using metadata about jobs that don’t require a background check. | Eliminates questions on job applications that ask about criminal history. Allows formerly incarcerated people  more access to the application and interview process.                                          |
| **Where does the existing solution fall short? ** | Very limited to a small portion of the country. Not offered in local jails either. Services were even more limited during the COVID-19 pandemic, meaning there is inequity in access to these services. This solution also means that the name of the carceral institution is on the recipient's resume. | Need a device that can connect to the internet. Many jobs listed are for trucking and warehouse work. This career board does not provide resources for upskilling workers.                 | Employers can still discriminate/assume people have been incarcerated. Employers are still allowed to run background checks and choose to not employ a person based on information from the background check. |
| **How are they similar?**                         | This is similar to the other solutions because this helps individuals by giving them information that can be used to get a job                                                                                                                                                                           | This is similar to the other solutions because this helps individuals get a job and places responsibility in the hands of the formerly incarcerated person.                                | This is similar to the other solutions because this helps individuals get a job by leveraging the information landscape to the advantage of the incarcerated person.                                          |
| :------------------------------------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
|                                                   |                                                                                                                                                                                                                                                                                                          |                                                                                                                                                                                            |                                                                                                                                                                                                               |
